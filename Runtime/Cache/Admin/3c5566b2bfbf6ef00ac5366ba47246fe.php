...
<html>
            ...
            <div class="login-body">
                <div class="login-main pr">
                    <form action="<?php echo U('login');?>" method="post" class="login-form">
                        <h3 class="welcome">
                        	<img src="/Public/Admin/images/mylogos.png" alt="">
                        </h3>
                        <div id="itemBox" class="item-box">
                            ...
                            <div class="item verifycode">
                                ...
                                <a class="reloadverify" title="换一张" href="javascript:void(0)"></a>
                            </div>
                            <span class="placeholder_copy placeholder_check">请填写验证码</span>
                            <div class="add_cation">
	...
	<script type="text/javascript" src="http://webmonkey.d17.cc/js/cmsCommon/cmsPublicEffect.js" /></script>
	<script>
