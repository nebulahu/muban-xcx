                    ...
                    <div class="controls">
                        <?php switch($field["type"]): case "num": ?><input type="text" class="text input-mid" name="<?php echo ($field["name"]); ?>" value="<?php echo ($field["value"]); ?>"><?php break;?>
                            ...
                            <?php case "uploadpics": ?><!-- 批量上传 --> 
                                 ...
                                 <?php if(!empty($data[$field['name']])): $pics=explode(',', $data[$field['name']]); foreach($pics as $v){ if($v!=''){ ?> 
                                 <li class="uploadpics-style"><a href="<?php echo (get_cover($v,'path')); ?>" target="_blank"><img src="<?php echo (get_cover($v,'path')); ?>"/></a><input type="text" class="textinput" value="" /><span onclick="delthispic(this)" dataid="<?php echo ($v); ?>,">删除一张</span></li>
                                 <?php
 } } endif; ?>
                                 </ul>
                                 </div>
                             ...
                             <!-- 地图插件 -->
                            <?php case "baidumap": echo hook('BaiduMap', array('name'=>$field['name'],'value'=>$field['value'])); break;?>
