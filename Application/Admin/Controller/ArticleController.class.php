...
class ArticleController extends AdminController {
   ...
   /** 
    ...
    protected function getDocumentList($cate_id=0,$model_id=null,$position=null,$field=true,$group_id=null){
		...
		//echo M('Document')->getLastSql();//exit;
        if($map['pid']){
            // 获取上级文档
     ...
     * @author huajie <banhuajie@163.com>
     */
    public function mydocument($status = null, $title = null,$cate_id = null, $model_id = null, $position = null,$group_id=null){
        //获取左边菜单
        $this->getMenu();
