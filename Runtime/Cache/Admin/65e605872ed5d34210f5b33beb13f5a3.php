...
<!--                <li><a href="<?php echo U('User/updateNickname');?>">修改昵称</a></li>-->
	...
	<div class="main-title">
        ...
        [ <a href="<?php echo U('index');?>">全部</a>&nbsp;
          <a href="<?php echo U('index?type=1');?>">业务员</a>&nbsp; 
        ]
        </h2>
	</div>
	<div class="cf">
		<div class="fl">
            ...
            <button class="btn ajax-post" url="<?php echo U('changeStatus?method=forbidUser');?>" target-form="ids">禁 用</button>-->
             <button class="btn ajax-post" url="<?php echo U('User/changeaudit');?>" target-form="ids">通过审核</button>
             <button class="btn ajax-post" url="<?php echo U('User/auditerror');?>" target-form="ids">拒绝审核</button>
    ...
    <tbody>
		<?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if(($vo['uid']) != "1"): ?><tr>
            ...
            <td><?php echo (getUserType($vo["type"])); ?><br/><?php if($vo['type'] != 1): ?>(业务员ID：<?php echo ($vo["type_mid"]); ?>)<?php endif; ?></td>
			...
			<td>
                ...
                <a href="<?php echo U('User/edit?uid='.$vo['uid']);?>" class="authorize">编辑</a>
				<a href="<?php echo U('AuthManager/group?uid='.$vo['uid']);?>" class="authorize">授权</a>
                <a href="<?php echo U('User/change?uid='.$vo['uid']);?>" target="_blank" class="authorize">进入帐号</a>
